	...
	**/
	...
	function ampExtension(options)
	{
		...
		var ampObj = 
		{
			...
			primeStimulusCSS : {color:'#000000','font-size':'3.3em'},
			...
			// Get the font size of primeStimulusCSS
			var primeStimulusCSS = document.querySelector('#primeStimulusCSS');
			var fontSize = window.getComputedStyle(primeStimulusCSS).getPropertyValue('font-size');

			// Set the font size of examplePrimeStimulus to the same value
			var examplePrimeStimulus = document.querySelector('#examplePrimeStimulus');
			examplePrimeStimulus.style.fontSize = fontSize;
			
			//The CSS for all the target stimuli (usually irrelevant because the targets are Chinese pictographs.
			targetStimulusCSS : {color:'#0000FF','font-size':'3.3em'},
			//The prime categories.
			targetCats :  [
				{
			...
			trialsInBlock : [30, 30, 30], //Number of trials in each block 
			...
			exampleBlock_primeDuration : 150, 
			...
			'Press the key <B>leftKey</B> if the targetCat is more leftAttribute than average. ' + 
			'Hit the <b>rightKey</b> key if it is more rightAttribute than average.<br/><br/>' + 
			...
			'Concentrate on each targetCat and rate it as more leftAttribute than the average targetCat with the <b>leftKey</b> key, ' + 
			'or more rightAttribute than average with the <b>rightKey</b> key.<br/><br/>' + 
			...
			'Concentrate on the targetCat and rate it as more leftAttribute than average with the <b>leftKey</b> key, ' + 
			'or more rightAttribute than average with the <b>rightKey</b> key.<br/><br/>' + 
			'Evaluate each targetCat and not the item that appears before it. ' + 
